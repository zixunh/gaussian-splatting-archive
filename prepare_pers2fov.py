...
def colmap_main(args):
    ...
    u, v = u.astype(np.float32), v[:, 0].astype(np.float32)
    u, v = np.meshgrid(u, v)
    print("P", u.shape, v.shape)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--path', type=str, default="/home/choyingw/Documents/0221_clone/gaussian-splatting/datasets/zipnerf/official_undistorted/nyc/")
    parser.add_argument('--src', type=str, default="images")
    parser.add_argument('--dst', type=str, default="fovmaps")
