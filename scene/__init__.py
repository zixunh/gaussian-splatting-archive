...
from utils.camera_utils import (
    ...
    camera_to_JSON,
    cameraList_from_camInfos_fisheye,
    cameraList_from_camInfos_mvg,
)
...
def check_blender(args):
    return os.path.exists(os.path.join(args.source_path, "transforms.json")) or os.path.exists(
...
def check_scannetpp(args):
    return os.path.exists(os.path.join(args.source_path, "resized_images")) or os.path.exists(
...
class Scene:
    ...
    def __init__(
        ...
        skip_train_cameras=False,
        skip_test_cameras=False,
    ):
        """b
        ...
        for resolution_scale in resolution_scales:
            if not skip_train_cameras:
                ...
                self.train_cameras[resolution_scale] = cameraList_from_camInfos_fisheye(
                    scene_info.train_cameras, resolution_scale, False, False, args
                )
            if not skip_test_cameras:
                print("Loading Test Cameras")
                self.test_cameras[resolution_scale] = cameraList_from_camInfos_fisheye(
                    scene_info.test_cameras, resolution_scale, False, True, args
                )
...
class Scene_mvg:
    ...
    def __init__(
        ...
        for resolution_scale in resolution_scales:
            if not skip_train_cameras:
                print("Loading Training Cameras")
                self.train_cameras[resolution_scale] = cameraList_from_camInfos_mvg(
                    scene_info.train_cameras, resolution_scale, args
                )
            if not skip_test_cameras:
                print("Loading Test Cameras")
                self.test_cameras[resolution_scale] = cameraList_from_camInfos_mvg(
